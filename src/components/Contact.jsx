import { isValidEmail } from '../hooks/useContact'
...
export default function Contact({ t, form, setForm, sent, sending, sendError, handleSend }) {
      ...
      <div className="contact-grid">
        <div>
          ...
          <div className="socials">
            <a className="soc" href="https://github.com/GianGrav" target="_blank" rel="noopener noreferrer">
              <span className="soc-ic"><GitHubIcon /></span> GitHub
            </a>
            <a className="soc" href="https://www.linkedin.com/in/giancarlo-gravagna" target="_blank" rel="noopener noreferrer">
              <span className="soc-ic"><LinkedInIcon /></span> LinkedIn
            </a>
          </div>
        </div>
        <div className="cform">
          ...
          {sent ? (
            ...
            <button className="fsend" onClick={handleSend} disabled={!canSend}>
