...
const content = {
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: 'PWA que junta el día a día en un solo lugar: agenda, entrenamiento, finanzas y facultad. Once pantallas sobre un sistema de componentes propio, con heatmap y gráficos dibujados a mano en SVG.',
          note: 'Lo muestro en desarrollo a propósito: la parte más difícil —el diseño y la arquitectura— ya está resuelta.',
  ...
  en: {
    ...
    about: {
      title: 'About Me',
      text: 'For 4 years I have been building web applications and taking them to production: data model, backend, interface and the deployment that keeps them running. I built a store that actually takes payments and a finance app I use every day. I care more about leaving decisions I can defend and code the next person can touch without fear — myself included six months from now — than about adding whatever framework is in fashion.',
      facts: [
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          status: 'wip',
          cover: '/projects/atrialife.jpg',
          desc: 'PWA that pulls everyday life into one place: schedule, training, finances and university. Eleven screens on a custom component system, with a heatmap and progression charts hand-drawn in SVG.',
          note: 'I show it in development on purpose: the hardest part — the design and the architecture — is already done.',
          stack: STACK.atrialife,
          repo: null,
          demo: null,
        },
